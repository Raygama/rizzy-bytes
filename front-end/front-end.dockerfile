...
ARG NEXT_PUBLIC_NGINX_FLOWISE_BASE=
ARG NEXT_PUBLIC_NGINX_PROM_BASE=/prometheus
ARG NEXT_PUBLIC_DIRECT_API_BASE=http://localhost:3001
ARG NEXT_PUBLIC_DIRECT_FLOWISE_BASE=http://localhost:4000
...
ENV NEXT_PUBLIC_DIRECT_API_BASE=${NEXT_PUBLIC_DIRECT_API_BASE}
ENV NEXT_PUBLIC_DIRECT_FLOWISE_BASE=${NEXT_PUBLIC_DIRECT_FLOWISE_BASE}
