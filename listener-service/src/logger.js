...
const SERVICE_NAME = process.env.SERVICE_NAME || "listener-service";
const LOG_ENDPOINT =
...
const SENSITIVE_KEYS = ["password", "token", "otp", "secret", "authorization", "cookie"];
